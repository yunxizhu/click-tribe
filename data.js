  ...
  tutorial: {
    steps: [
      ...
      },
      {
        id: 'open_tech_tree',
        title: '打开科技树',
        text: '点右侧「科技」，打开科技树页面，可以看到各项科技。',
        highlight: ['.tab-btn[data-tab="tech"]'],
      },
      {
        id: 'unlock_workbench',
        title: '解锁工作台',
        text: '在科技树页面找到「工作台」并点击解锁。',
      ...
      },
      {
        id: 'craft_tool',
        title: '制作木斧',
        text: '工具制作已解锁。打开「工具」页，用宝箱里的木头+木板下单制作「木斧」。',
      ...
      },
      {
        id: 'assign_forest',
        title: '分配村民',
        text: '可以给森林分配村民，他们会自动砍树。点下方工人栏的「+」派出至少 2 人。',
      ...
      },
      {
        id: 'food_intro',
        title: '别忘了食物',
        text: '记得采集食物！食物不够时村民会饥饿并降低效率；若连续缺粮，村民还会饿死。先去左侧「浆果丛」采集 3 次。',
      ...
      },
      {
        ...
        title: '工具提升效率',
        text: '森林和浆果丛都已分配村民，注意下方效率提示——有工具的村民效率远高于徒手。去「工具」页制作斧头和篓子可大幅提升采集速度。',
      ...
      },
      {
        id: 'craft_plank',
        title: '第一件加工品',
        text: '「合成」页下单制作木板。下单后会跳到中间加工界面，点击做出 1 块即可。',
      ...
      },
      {
        id: 'defense_assign',
        title: '出战编制',
        text: '请至少编入 1 名战斗人员（弓/剑等，受武器库存限制）。',
      ...
      },
      {
        ...
        title: '战场布阵',
        text: '左侧战场可操控友军：左键拖拽框选/点选；Ctrl+左键加减选；右键下令移动；中键在鼠标处切换列阵（竖列→横列→聚团）。看完点「下一步」。',
      ...
      },
      {
        id: 'defense_gate',
        title: '城门与袭击',
        text: '城门可升级；战时未编入战斗的村民自动修门。首次袭击约第 7 天，第 5 天预警。点「下一步」。',
